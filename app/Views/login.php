        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <img src="assets\img\custom\Screenshot 2024-03-18 081623.png" width="350px" height="300px">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url('home/aksi_login')?>" method="POST">
                ...
                <div class="mb-3">
                 <p class="text-center mt-2 mb-0"><a href="<?= base_url('home/user')?>">Don't have an account? Register here</a></p>
                </div>
              </form>
            </div>
          </div>
